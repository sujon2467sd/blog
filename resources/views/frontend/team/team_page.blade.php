                               ...
                               <a href=""><p class="p-2 text-dark" >  {{ $team->memberDetails ? Str::limit($team->memberDetails->details, 150) : 'N/A' }}</p></a>
                                 ...
                                 <hr>
                                     <ul class="social-links float-right" style="display: flex; ">
                                        ...
                                        <li style="padding: 0px 10px; font-size:25px;"><a href="{{ $team->memberDetails ? $team->memberDetails->facebook ?? 'N/A' : '' }}" class="text-primary" ><i class="fa fa-facebook"></i></a></li>



                                        <li style="padding: 0px 10px; font-size:25px;" class="text-danger"><a href="{{ $team->memberDetails ? $team->memberDetails->youtube ?? 'N/A' : '' }}" class="text-danger"><i class="fa fa-youtube-play"></i></a></li>



                                        <li style="padding: 0px 10px; font-size:25px;" class="text-info"><a href="{{ $team->memberDetails ? $team->memberDetails->twitter ?? 'N/A' : '' }}" class="text-info"><i class="fa fa-linkedin" ></i></a></li>



                                        <li style="padding: 0px 10px; font-size:25px;"><a href="{{ $team->memberDetails ? $team->memberDetails->instagram ?? 'N/A' : '' }}" class="text-pink"><i class="fa fa-instagram"></i></a></li>
